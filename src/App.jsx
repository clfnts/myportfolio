...
const projectDetails = [
  {
    ...
    details: (
      <>
        <b>Digital Creator / Business Owner</b><br/>
        Self-Employed – Shopee Store<br/>
        📍 Remote | 🗓️ 2019 – 2023<br/>
        • Created and sold handmade products and digital stickers<br/>
        • Designed assets using Procreate, Illustrator, Photoshop<br/>
        • Managed customer service, logistics, and fulfillment<br/>
  ...
  },
  {
    ...
    details: (
      <>
        ...
        WPP Marketing Communications Inc. (J. Walter Thompson Philippines)<br/>
        📍 Makati | 🗓️ Feb – May 2025<br/>
        • Built a full-stack CRM using MongoDB, Next.js, Passport.js, and Tanstack Query<br/>
        • Developed backend APIs and automated internal emails using Appscript<br/>
  ...
  },
  {
    ...
    details: (
      <>
        <b>Student Leader – Senior High School</b><br/>
        STI College Bacoor | 2019–2021<br/>
        • Organized events, led meetings, and coordinated with administrators<br/>
  ...
  },
  {
    ...
    details: (
      <>
        <b>SHUTL. (Capstone Project)</b><br/>
        Shuttle locator system with real-time tracking and analytics<br/>
        A real-time shuttle locator web app with GPS tracking, chat system, admin dashboard, and analytics.<br/>
        • Role: Documentation, Project Manager, Frontend, & Partial Backend Developer<br/>
        • Built using Node.js, Express.js, MongoDB, Socket.io, and OpenStreetMap API<br/>
        • Features: include live shuttle tracking, user management, reporting tools, and Linux-based deployment<br/>
        <a href="https://www.canva.com/design/DAGiCePheCs/oS3cmU9BKUXPZgZ4WMR8LQ/edit?utm_content=DAGiCePheCs&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton" target="_blank" rel="noopener noreferrer">Project Demo/Design</a>
      </>
    )
  },
  {
    ...
    details: (
      <>
        <b>Wing 'N Grill</b><br/>
        Online info management website to enhance sales for a local restaurant.<br/>
  ...
  },
  {
    ...
    details: (
      <>
        <b>MC Fmly Online Inventory System</b><br/>
  ...
  },
  {
    ...
    details: (
      <>
        <b>BarbedFlower E-Commerce Platform</b><br/>
...
function App() {
  ...
  return (
    <>
      <div className="portfolio-container">
        ...
        <section className="fullscreen-section" id="about-section" style={{marginBottom: '4rem'}}>
          ...
          <div className="about-text" style={{whiteSpace: 'pre-line'}}>
            <b>Dolcielo B. Fuentes</b><br/>
            Information Technology specialized in Web Development Professional<br/>
            Cavite, Philippines | dolcielofuentes03@gmail.com | +63 9761538500 | GitHub: <a href="https://github.com/clfnts" target="_blank" rel="noopener noreferrer">github.com/clfnts</a><br/><br/>
            <b>Professional Summary</b><br/>
            Hi! I’m a tech-savvy and passionate IT graduate from De La Salle University - Dasmariñas. I specialize in web development and digital design, with hands-on experience building full-stack applications, backend systems, and user-friendly interfaces. I'm a fast learner, team player, and love using technology to create functional and visually appealing solutions.<br/><br/>
            <b>Education</b><br/>
          ...
          <div className="projects-list">
            {projectDetails.map((proj, idx) => (
              <div className="project-card" key={proj.title}>
                <h3>{proj.title}</h3>
                <p>{proj.short}</p>
                <button className="details-btn" onClick={() => setOpenProject(idx)}>View Details</button>
              </div>
            ))}
          </div>
          <div style={{
        ...
        {openProject !== null && (
          <div className="modal-overlay" style={{position:'fixed',top:0,left:0,width:'100vw',height:'100vh',background:'rgba(0,0,0,0.5)',zIndex:2000,display:'flex',alignItems:'center',justifyContent:'center'}} onClick={()=>setOpenProject(null)}>
            <div className="modal-content" style={{background:'#fff',color:'#181b1b',padding:'2rem',borderRadius:'1.2rem',maxWidth:'95vw',maxHeight:'90vh',overflowY:'auto',boxShadow:'0 4px 32px 0 rgba(0,0,0,0.18)'}} onClick={e=>e.stopPropagation()}>
              <button style={{float:'right',background:'none',border:'none',fontSize:'1.5rem',cursor:'pointer',color:'#a60000'}} onClick={()=>setOpenProject(null)}>&times;</button>
              <h2 style={{marginTop:0}}>{projectDetails[openProject].title}</h2>
              <div style={{marginTop:'1.2rem',fontSize:'1.1rem'}}>{projectDetails[openProject].details}</div>
            </div>
          </div>
        )}
      ...
      <div className="floating-cartoon" onClick={handleCartoonClick} style={{ cursor: 'pointer', bottom: '40px', right: '20px', position: 'fixed' }}>
        <img src={cartoonSrc} alt="Cartoon" />
      </div>
      <div className="floating-move-gif" onClick={handleMoveGifClick} style={{ cursor: 'pointer', bottom: '40px', left: '30px', position: 'fixed' }}>
